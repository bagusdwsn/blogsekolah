...
function Navbar({ data }) {
  ...
  return (
    <header>
      <div>
        <nav className="bg-transparrent shadow-md flex-col w-full z-10 sm:px-10">
                ...
                <div className="hidden md:block">
                  <div className="ml-10 flex items-baseline space-x-4">
                    <Link href="/" smooth={true} offset={50} duration={500}>
                      <h1 className="cursor-pointer text-blue-600 font-semibold px-3 py-2 text-md hover:font-black">
                        Home
                      </h1>
                    </Link>
                    <Link href="/Profil">
